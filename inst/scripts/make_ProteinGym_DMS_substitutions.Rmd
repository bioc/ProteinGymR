...
"ANCSZ_Hobbs_2022" assay, which comprised a manual protein reconstruction by the 
original authors and thus had no matching UniProt accession. Therefore, this 
list contains a total of 216 elements, each corresponding to a data.frame for 
a single DMS assay. Each data.frame contains the following columns:
...
**DMS_score_bin (int):** indicates whether the DMS_score is above the fitness 
cutoff defined by ProteinGym (1 is fit, 0 is not fit).
