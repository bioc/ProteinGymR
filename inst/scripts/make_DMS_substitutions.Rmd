...
The 217 DMS substitution assays and the reference file for these assays 
(metadata) were accessed from the [ProteinGym Zenodo][Zenodo] repository (v1.1).
(accessed 2024-10-16).
...
# Data stored locally
MAVE_dir <- "/home/rstudio/ProteinGym_data/ProteinGym_v1.1/DMS_ProteinGym_substitutions/"
...
Returns a list of 217 unique DMS assays, each with 6 columns:
...
saveRDS(ProGym_tables, 
    "/home/rstudio/ProteinGym_data/EH_data/v1.1/ProGym217_DMS_subs_v1.1.rds")
```
...
```{r, eval=FALSE}
ref_file <- 
    read_csv("/home/rstudio/ProteinGym_data/ProteinGym_v1.1/DMS_substitutions.csv")
...
saveRDS(ref_file, 
    "/home/rstudio/ProteinGym_data/EH_data/v1.1/ref_file_217_DMS_subs_v1.1.rds")
```
