...
assays.We provide these assays in a list object, with the exception of
the "ANCSZ_Hobbs_2022" assay, which comprised a manual protein
reconstruction by the original authors and thus had no matching UniProt
accession. Therefore, this list contains a total of 216 elements, each
corresponding to a data.frame for a single DMS assay. 
...
```{r, eval=FALSE}
saveRDS(ProGym_tables, "ProGym216_DMS_subs_v1.rds")
```
