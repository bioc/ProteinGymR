...
"Top_recall") for 79 models across 217 assays calculated on DMS substitutions 
...
6. Model scores on the DMS substitutions for 11 semi-supervised models. 


# Import ProteinGym data

In Bioc 3.20, ProteinGym data is accessed through ExperimentHub. Bioc 3.21 
allows for dual importation, from ExperimentHub or through Zenodo's API which 
accesses the current Zenodo database version.
...
benchmark_models(metric = "AUC", 
    models = c("GEMME", "CARP_600K", "ESM1b", "EVmutation", "ProtGPT2"))
```
